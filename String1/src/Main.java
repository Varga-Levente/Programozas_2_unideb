public class Main
{
    ...
    {
        String first_char = String.valueOf(s.charAt(0));
        return first_char+s.substring(1).replace(first_char, "*");
    }
    ...
    {
        String a_two = a.substring(0,2);
        String b_two = b.substring(0,2);
        return b_two+a.substring(2)+" "+a_two+b.substring(2);
    }
