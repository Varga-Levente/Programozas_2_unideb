...
public class Utils {
    ...
    public static void fillHashMap(@NotNull Map<Integer, Map.Entry<String, String>> plangs){
    ...
    public static @NotNull String spacer(@NotNull String s, @NotNull String s2){
